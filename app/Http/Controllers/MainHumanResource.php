...
class MainHumanResource extends Controller
{
    ...
    public function NewRoles(Request $request)
    {
        ...
        if (Str::of($request->Email)->contains(['ECSA-HC.or.ug'])) {
            ...
            $details = [
                'Title' => 'Hello ' . $E->StaffName . ', You ECSA-HC MIS account has been created successfully',
            ...
            return back()->with('error_a', 'Only ECSA-HC issued emails are allowed');
    ...
    public function NewStaffDesignation(Request $request)
    {
        $validated = $this->validate($request, [
