...
class AnalyticsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if (\Schema::hasColumn('grants', 'RecordStatus')) {

        } else {
            \Schema::table('grants', function ($table) {
                $table->string('RecordStatus')->default('valid');
            });
        }
    ...
    public function ReturnYearlyBVA($id, $Year)
    {
        ...
        $Budget = $Grants->AvailableGrantAmountInUgx;
