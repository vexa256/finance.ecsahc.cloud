    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('NewDoc')); ?>" class="row" method="POST" enctype=multipart/form-data> <?php echo csrf_field(); ?> <div
                    class="row">
        ...
        <input type="hidden" name="Department" value="<?php echo e($E->Department); ?>">

        <input type="hidden" name="Designation" value="<?php echo e($E->Designation); ?>">


        <input type="hidden" name="StaffName" value="<?php echo e($E->StaffName); ?>">

        <input type="hidden" name="DOCID" value="<?php echo e(\Hash::make($E->EmpID)); ?>">
...
<?php /**PATH /var/www/html/africhild.mis/hr/docs/NewDoc.blade.php ENDPATH**/ ?>