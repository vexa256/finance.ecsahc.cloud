...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('ActSelected')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <label id="label" for="" class="px-5   my-5 required form-label">Select Activity (Activity Costing)</label>
                    <select required name="id" class="form-select  py-5   my-5 form-select-solid" data-control="select2"
                        ...
                        <option value="<?php echo e($data->id); ?>"><?php echo e($data->Activity); ?></option>
...
<?php /**PATH /var/www/html/africhild.mis/proj/activities/SelAct.blade.php ENDPATH**/ ?>