...
<body id="kt_body" class="bg-dark">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            style="background-size1: 100% 50%; background-image: url(assets/bg.svg)">
            <!--begin::Content-->
            <div
                class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                <a href="/" class="mb-12">
                    <img alt="Logo" src="<?php echo e(asset('logos/logo2.png')); ?>"
                        class="h-100px" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div
                    ...
                    <form class="form w-100" novalidate="novalidate"
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">ECSA-HC Cloud Login</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                            <div class="text-gray-400 d-none fw-bold fs-4">New
                                Here?
                                <a href="<?php echo e(url('register')); ?>"
                                    class="link-primary fw-bolder">Create an
                                    Account</a>
                                <!-- Session Status -->
                                <br>
...
<?php endif; ?>
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <a href="<?php echo e(url('forgot-password')); ?>"
                                    class=" d-none link-primary fs-6 fw-bolder">Forgot
                                    Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
    ...
    <?php echo $__env->make('scripts.authscripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/html/finance.ecsa/resources/views/auth/login.blade.php ENDPATH**/ ?>