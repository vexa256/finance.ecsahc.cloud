<?php if(Auth::user()->role == 'superadmin' || Auth::user()->role == 'hrandfinance'): ?>
...
<?php if(Auth::user()->role == 'staffaccount'): ?>
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion ">
        <span class="menu-link">
            <span class="menu-icon">
                <i class="fas fa-users-cog fs-3" aria-hidden="true"></i>
...
<?php endif; ?>
<?php /**PATH /var/www/html/africhild.mis/views/sidebar/Leave.blade.php ENDPATH**/ ?>