    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('NewDeduction')); ?>" class="row" method="POST" enctype=multipart/form-data> <?php echo csrf_field(); ?> <div
                    class="row">
            ...
            <?php echo Form::hidden($name="DID", $value=\Hash::make(uniqid()."AFC".date('Y-m-d H:I:S')), [$options=null]); ?>
...
<?php /**PATH /var/www/html/africhild.mis/hr/deductions/New.blade.php ENDPATH**/ ?>