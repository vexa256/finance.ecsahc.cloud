<?php if(Auth::user()->role == 'superadmin' || Auth::user()->role == 'hrandfinance' || Auth::user()->role == 'projectmanager' ): ?>
...
<?php /**PATH /var/www/html/africhild.mis/views/sidebar/stats.blade.php ENDPATH**/ ?>