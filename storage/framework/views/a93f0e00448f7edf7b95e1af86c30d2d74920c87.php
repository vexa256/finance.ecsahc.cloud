...
<div class="modal fade"  id="ApproveLeave<?php echo e($data->id); ?>">
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('ApproveLeave')); ?>" class="row" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/africhild.mis/hr/leave/Approve.blade.php ENDPATH**/ ?>