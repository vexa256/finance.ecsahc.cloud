...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(route('GrantActivityAccepted')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3 col-md-12  py-5   my-5">
                    <label id="label" for=""
                        class="px-5   my-5 required form-label">Select Activity (Activity
                        Grant Impact Analysis)</label>
                    <select required name="id"
                        ...
                        <?php if(isset($Activities)): ?>
                            ...
                            <?php $__currentLoopData = $Activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->Activity); ?>
...
<?php /**PATH /var/www/html/africhild.mis/ActUpdate/stat/SelectActivity.blade.php ENDPATH**/ ?>