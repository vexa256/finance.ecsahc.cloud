    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('AssignDeduction')); ?>" method="POST"  class="row">
                    <div class="mb-3 col-md-12  ">
                        ...
                        <select required name="DID" class="form-select  form-select-solid" data-control="select2" data-placeholder="Select an option">
                            <option></option>
                            <?php if(isset($SDeductions)): ?>

                            <?php $__currentLoopData = $SDeductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($data->DID); ?>"><?php echo e($data->Deduction); ?></option>
...
<?php /**PATH /var/www/html/africhild.mis/hr/payroll/AssignDed.blade.php ENDPATH**/ ?>