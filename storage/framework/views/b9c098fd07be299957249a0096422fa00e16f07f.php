        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <table class="table mytable table-dark table-rounded table-bordered  border gy-3 gs-3">
                    ...
                    <tbody>
                        <?php if(isset($ReturnBenLogs)): ?>
                        <?php $__currentLoopData = $ReturnBenLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(number_format($data->BAmount)); ?> UGX</td>
...
<?php /**PATH /var/www/html/africhild.mis/hr/payroll/ViewBen.blade.php ENDPATH**/ ?>