    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('NewLeave')); ?>" class="row" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mb-3 col-md-12 pt-3 mt-3">
                    ...
                    <?php echo Form::hidden($name="LID", $value=\Hash::make(uniqid()."LID".date('Y-m-d H:I:S')), [$options=null]); ?>
...
<?php /**PATH /var/www/html/africhild.mis/hr/leave/New.blade.php ENDPATH**/ ?>