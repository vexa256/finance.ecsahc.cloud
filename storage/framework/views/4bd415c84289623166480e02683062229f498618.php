    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <form action="<?php echo e(route('RunPayroll')); ?>" method="POST" class="row">
                    <div class="col-md-6">
                        <div class="mb-10">
                    ...
                    <input type="hidden" name="PayID" value="<?php echo e(\Hash::make(uniqid()."PID".date('Y-m-d H:I:S'))); ?>">

                    <input type="hidden" name="Deduction" value="<?php echo e($Deductions); ?>">

                    <input type="hidden" name="Benefits" value="<?php echo e($Benefits); ?>">

                    <input type="hidden" name="Taxes" value="<?php echo e($TaxableAmount); ?>">

                    <input type="hidden" name="SalaryPaid" value="<?php echo e($NetSalary); ?>">

                     <input type="hidden" name="GrossSalary" value="<?php echo e($Salary); ?>">
...
<?php /**PATH /var/www/html/africhild.mis/hr/payroll/Pay.blade.php ENDPATH**/ ?>