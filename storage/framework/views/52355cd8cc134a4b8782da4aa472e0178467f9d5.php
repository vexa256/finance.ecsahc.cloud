    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="<?php echo e(route('NewEmp')); ?>" class="row" method="POST" enctype=multipart/form-data> <?php echo csrf_field(); ?> <div
                    class="row">
...
<?php /**PATH /var/www/html/africhild.mis/hr/emp/NewEmp.blade.php ENDPATH**/ ?>