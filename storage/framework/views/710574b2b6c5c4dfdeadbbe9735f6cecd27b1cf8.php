                 ...
                 <?php $__currentLoopData = $Employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                         ...
                         <td>
                             ...
                             <a href="#Update<?php echo e($data->id); ?>"
                                 ...
                                 <div class="dropdown">
                                     ...
                                     <ul class="dropdown-menu"
                                         ...
                                         <li><a data-bs-toggle="modal"
                                                 class="dropdown-item "
                                                 href="#PersonalDetails<?php echo e($data->id); ?>">Personal
                                                 Details</a></li>

                                         <li><a data-bs-toggle="modal"
                                                 class="dropdown-item "
                                                 href="#BankDetails<?php echo e($data->id); ?>">Bank
                                                 Details</a></li>
...
<?php /**PATH /var/www/html/finance.ecsa/hr/emp/MgtEmp.blade.php ENDPATH**/ ?>