    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">You are viewing a document
                    <span class="text-danger font-weight-bold">
                            <span id="Doc"></span>  attached to the grant <?php echo e($E->GrantName); ?>
...
<?php /**PATH /var/www/html/africhild.mis/proj/grants/PDFJS.blade.php ENDPATH**/ ?>