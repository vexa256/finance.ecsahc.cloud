    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-size1: 100% 50%; background-image: url(assets/bg.svg)">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                <!--begin::Logo-->
                <a href="/" class="mb-12">
                    <img alt="Logo" src="<?php echo e(asset('logos/logo2.png')); ?>" class="h-100px" />
                </a>
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <a href="<?php echo e(url('register')); ?>" class="link-primary fw-bolder">Create an Account</a>
                        <!-- Session Status -->
                        <br>
...
<?php endif; ?>
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Link-->
                                <a href="<?php echo e(url('forgot-password')); ?>" class=" d-none link-primary fs-6 fw-bolder">Forgot Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Input-->
...
<?php /**PATH /var/www/html/africhild.mis/resources/views/auth/login.blade.php ENDPATH**/ ?>