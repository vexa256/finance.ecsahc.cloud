...
<head>
    <base href="">
    <title>Africhild Center | <?php if(isset($Title)): ?>
            <?php echo e($Title); ?>
    ...
    <link href="<?php echo e(asset('assets/plugins/global/plugins.bundle.css')); ?>"
...
<!--end::Head-->
<!--begin::Body-->
<?php /**PATH /var/www/html/africhild.mis/views/header/header.blade.php ENDPATH**/ ?>