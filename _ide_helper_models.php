 ...
 * @property int $id
 * @property string $GrantName
 * @property int|null $GrantAmountAlreadySpentInUgx
 * @property int|null $AvailableGrantAmountInUgx
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Grants whereAvailableGrantAmountInUgx($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Grants whereGrantAmountAlreadySpentInUgx($value)
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments query()
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereActivityID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereComment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereSupervisor($value)
 * @method static \Illuminate\Database\Eloquent\Builder|SupervisorComments whereUpdatedAt($value)
 */
	class SupervisorComments extends \Eloquent {}
}
 ...
 * @property int $DurationInWeeks
 * @property string $Description
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property string $Activity
 * @property string|null $SupervisorComment
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereActID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereActivity($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereActivityID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereActivityLocation($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereCatID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereDurationInWeeks($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereEmpID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereEndDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereMonth($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereStartDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereSupervisor($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereSupervisorComment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Tracking whereYear($value)
 */
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories query()
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereCatID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereCategory($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereEmpID($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|TrackingCategories whereUpdatedAt($value)
 */
	class TrackingCategories extends \Eloquent {}
}
